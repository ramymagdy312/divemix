    ...
    <div>
      ...
      <section className="relative h-[600px] flex items-center">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-white">
          ...
          <p className="text-xl mb-8 max-w-2xl">
            Leading the industry with innovative solutions for gas mixing and compression systems.
            Trust DiveMix for reliability, precision, and excellence.
          </p>
          <a
            href="/products"
            className="inline-flex items-center px-6 py-3 bg-blue-600 rounded-md hover:bg-blue-700 transition-colors"
          >
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center mb-12">Why Choose DiveMix?</h2>
      ...
      <section className="bg-blue-900 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold mb-6">Ready to Upgrade Your Systems?</h2>
          <p className="text-xl mb-8">
            Contact our team of experts to find the perfect solution for your needs
          </p>
          <a
            href="/contact"
